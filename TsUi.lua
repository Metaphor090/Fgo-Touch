...
require("Tools")
TsUi = {}
VersionType = "触动精灵安卓" --触动精灵IOS  小精灵安卓 小精灵IOS
DefDir = "触动精灵IOS"
os_type = getOSType();
...
function TsUi.GetUI()
	...
	UILabel({text="日服：游戏引擎更新中。。。",color="65,105,225"});
	UILabel({text="国服：三周年",color="65,105,225"});
	UILabel({text="台服：情人节2019。",color="65,105,225"});
	...
	UICombo({num=2,id="助战选择",list="呆毛王,小莫,大王,闪闪,水呆毛,孔明,梅林,杀斯卡哈,杰克,枪斯卡哈,迦尔纳,拉二,船长,奶光,黑狗,黑贞,贞德lily,弓凛,黑骑呆,狂长江,艳后,水尼禄,R小莫,妖僧,狂金时,小恩,C狐,北斋,BX毛,武藏,冲田总司,花嫁尼禄,阿周那,特斯拉,弓凛,白枪呆,枪凛,山中老人,酒吞,BB,天草,伯爵,阿比,术尼托,枪狐,术师匠,枪奶光,大英雄",color="65,105,225"});
	--助战礼装选择
	UILabel(2,"助战礼装选择",15,"left","205,92,92",-1,0);
	UICombo({num=2,id="助战礼装选择",list="迦勒底午餐时光,圣夜晚餐,万华镜,达芬奇,宇宙棱镜,二零三零,天堂之孔,虚数魔术,黑杯,社交界之花,春风游步道,第六天魔王,日轮之城,壬生狼,铃铛,蜡烛,雪宝宝,喜羊羊,海滨奢华,白色航游,砂糖假期,小小夏日,迦勒底沙滩排球,Kingjokerjack,盛夏一刻,潜入湛蓝,甜蜜之日,法老巧克力,第一次的情人节,魔女厨房",color="65,105,225"});
	--助战礼装是否满破
	...
	--替补释放技能
	UILabel(2,"替补释放技能",15,"left","205,92,92",-1,0);
	UICombo(2,"替补释放技能","是,否","0","-1");
	--宝具判断
	...
	if UIRet == 0 then
		...
		SubstituteSkillGlo = 替补释放技能--替补释放技能
